...
import com.example.demo2.service.JpaUserDetailsService;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        .mvcMatchers("/api","/api-ui","/swagger-ui/**","/swagger-ui.html","/v3/api-docs/**","/api/swagger-config/**","/user/token/refresh/**").permitAll()
                        .mvcMatchers(HttpMethod.GET, "/products/**", "/categories/**").permitAll()
